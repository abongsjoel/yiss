...
const Button = ({text, btnColor}) => {
    ...
    let changingStyle = "hover:bg-blue-700 c-main border  border-blue-700 hover:text-white";
    if (btnColor === "white") {
        changingStyle = "hover:bg-white text-white border  border-white hover:text-blue-700";
    }
